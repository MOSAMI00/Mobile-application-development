...
Image _buildJournalHeaderImage() {
  return Image(
    image: AssetImage('images/360_F_57084608_ciyjhtwgdKSjeZwhDTNDyuMdWik8gNF9.jpg'),
    fit: BoxFit.cover,
  );
}
...
Column _buildJournalEntry() {
  return Column(
    ...
    children: <Widget>[
      ...
      favorite place, then watch a movie after we go to the gelateria for ice cream andespresso.''',
    ...
    children: <Widget>[
      ...
      Column(
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              Text('81º Clear', style: TextStyle(color: Colors.deepOrange)),
            ],
          ),
          Row(
            children: <Widget>[
...
Wrap _buildJournalTags() {
  return Wrap(
    ...
    children: List.generate(7, (int index) {
      return Chip(
        label: Text('Gift ${index + 1}', style: TextStyle(fontSize: 10.0)),
